...
ARG AVG_DATABASE_API_URL
ARG DEBUG_PASSWD
ARG GIT_COMMIT_HASH=unknown

# Set environment variables for Vite (must be ENV so loadEnv / process.env can read them)
...
ENV AVG_DATABASE_API_URL=${AVG_DATABASE_API_URL}
ENV DEBUG_PASSWD=${DEBUG_PASSWD}
