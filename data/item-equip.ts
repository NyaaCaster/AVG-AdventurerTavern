...
export const ITEMS_EQUIP: Record<string, ItemData> = {
  ...
  // --- 防具类 (arm) ---
  // 轻甲
  'arm-101': { id: 'arm-101', name: '长袍Lv1', category: 'arm', tag: 'L-Arm', quality: 'E', stats: { def: 0, agi: 1, matk: 10, mdef: 10 }, maxStack: 9, description: "比起防御力，更重要的是时尚！" },
  'arm-102': { id: 'arm-102', name: '长袍Lv2', category: 'arm', tag: 'L-Arm', quality: 'D', stats: { def: 0, agi: 2, matk: 20, mdef: 20 }, maxStack: 9, description: "在呼吸时就能产生魔力的纤维" },
  'arm-103': { id: 'arm-103', name: '长袍Lv3', category: 'arm', tag: 'L-Arm', quality: 'C', stats: { def: 0, agi: 3, matk: 40, mdef: 40 }, maxStack: 9, description: "这不是防具，是魔法师的武装！" },
  'arm-104': { id: 'arm-104', name: '长袍Lv4', category: 'arm', tag: 'L-Arm', quality: 'B', stats: { def: 0, agi: 4, matk: 80, mdef: 80 }, maxStack: 9, description: "魔法使者称其为「礼装」" },
  'arm-105': { id: 'arm-105', name: '长袍Lv5', category: 'arm', tag: 'L-Arm', quality: 'A', stats: { def: 0, agi: 5, matk: 160, mdef: 160 }, maxStack: 9, description: "能将吸收大气中魔力的织物" },
  'arm-106': { id: 'arm-106', name: '长袍Lv6', category: 'arm', tag: 'L-Arm', quality: 'S', stats: { def: 0, agi: 6, matk: 320, mdef: 320 }, maxStack: 9, description: "将魔力这个概念本身覆盖在皮肤上的现象" },
  // 中甲
